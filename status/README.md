...
| ABola | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/ABola_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: Exception`<br>❌ `Message: Unable to find css selector on https://abola.pt/Nnh/Noticias` |
...
| AnimeUltime | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/AnimeUltime_1.html) | ❌ `Bridge returned error 403! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: http://www.anime-ultime.net/history-0-1/102024Everything resulted in 403 Forbidden <html>` |
...
| ArtStation | [1 Search Query](https://User123698745.github.io/rss-bridge-artifacts/status/ArtStation_1.html) | ❌ `Bridge returned error 412! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://www.artstation.com/api/v2/search/projects.json resulted in 412 Precondition Failed Invalid CSRF Token` |
...
| BleepingComputer | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/BleepingComputer_1.html) | ❌ `HTTP status 503 Service Unavailable`<br>❌ `Type: HttpException`<br>❌ `Message: https://www.bleepingcomputer.com/news/security/over-6-000-wordpress-hacked-to-install-plugins-pushing-infostealers/ resulted in 503 Service Unavailable <html>` |
...
| Instagram | [1 Username](https://User123698745.github.io/rss-bridge-artifacts/status/Instagram_1.html) | ❌ `Bridge returned error 401! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://www.instagram.com/web/search/topsearch/?query=aesoprockwins resulted in 401 Unauthorized {"message":"Please wait a few minutes before you try again.","require_login":true,"igweb_rollout":true,"status":"fail"}` |
...
| InternetArchive | [1 Account](about:blank) | ✔️ |
...
| SeznamZpravy | [1 By Author](https://User123698745.github.io/rss-bridge-artifacts/status/SeznamZpravy_1.html) | ❌ `Bridge returned error 500! (20017)`<br>❌ `Type: Exception`<br>❌ `Message: Could not find articles for: https://seznamzpravy.cz` |
| Shanaproject | [1 *untitled*](about:blank) | ✔️ |
| Shimmie2 | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Shimmie2_1.html) | ❌ `Bridge returned error 404! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://shimmie.shishnet.org/post/list// resulted in 404 Not Found <!doctype html><html lang='en'>` |
| Sitemap | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Sitemap_1.html) | ❌ `Bridge returned error 404! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://example.com/blog/ resulted in 404 Not Found <!doctype html>` |
...
| SleeperFantasyFootball | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/SleeperFantasyFootball_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: ErrorException`<br>❌ `Message: Attempt to read property "src" on null` |
| Slushe | [1 Artist](https://User123698745.github.io/rss-bridge-artifacts/status/Slushe_1.html) | ❌ `Bridge returned error 403! (20017)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://slushe.com/lexx228 resulted in 403 Forbidden <!DOCTYPE html>` |
| Slushe | [2 Category](https://User123698745.github.io/rss-bridge-artifacts/status/Slushe_2.html) | ❌ `Bridge returned error 403! (20017)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://slushe.com/search/posts/channels?niche=71 resulted in 403 Forbidden <!DOCTYPE html>` |
| Slushe | [3 Search](https://User123698745.github.io/rss-bridge-artifacts/status/Slushe_3.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: cURL error URL using bad/illegal format or missing URL: 3 (https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://slushe.com/search/posts/pole dance?s=1` |
...
| SymfonyCasts | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/SymfonyCasts_1.html) | ❌ `Bridge returned error 404! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://symfonycasts.com/updates/find resulted in 404 Not Found ` |
...
| Teefury | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Teefury_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: ErrorException`<br>❌ `Message: Attempt to read property "attr" on null` |
...
| TheYetee | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/TheYetee_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: ErrorException`<br>❌ `Message: Attempt to read property "plaintext" on null` |
...
| TwitterV2 | [1 By username](https://User123698745.github.io/rss-bridge-artifacts/status/TwitterV2_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: Exception`<br>❌ `Message: Missing configuration option: twitterv2apitoken` |
| TwitterV2 | [2 By keyword or hashtag](https://User123698745.github.io/rss-bridge-artifacts/status/TwitterV2_2.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: Exception`<br>❌ `Message: Missing configuration option: twitterv2apitoken` |
| TwitterV2 | [3 By list ID](https://User123698745.github.io/rss-bridge-artifacts/status/TwitterV2_3.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: Exception`<br>❌ `Message: Missing configuration option: twitterv2apitoken` |
| UberNewsroom | [1 *untitled*](about:blank) | ✔️ |
| Unogs | [1 Global](https://User123698745.github.io/rss-bridge-artifacts/status/Unogs_1.html) | ❌ `Bridge returned error 500! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://unogs.com/api/search?query=new+last+7+days&limit= resulted in 500 Internal Server Error {"message": "Internal Server Error"}` |
| Unogs | [2 Country](https://User123698745.github.io/rss-bridge-artifacts/status/Unogs_2.html) | ❌ `Bridge returned error 500! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://unogs.com/api/search?query=new+last+7+days&countrylist=21&limit= resulted in 500 Internal Server Error {"message": "Internal Server Error"}` |
| UnraidCommunityApplications | [1 *untitled*](about:blank) | ✔️ |
| Unsplash | [1 *untitled*](about:blank) | ✔️ |
| Urlebird | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Urlebird_1.html) | ❌ `Bridge returned error 403! (20017)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://urlebird.com/user/willsmith/ resulted in 403 Forbidden <!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" conte...` |
...
| VideoCardz | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/VideoCardz_1.html) | ❌ `Bridge returned error 403! (20017)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://videocardz.com/sections/news resulted in 403 Forbidden <!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" conte...` |
| VieDeMerde | [1 *untitled*](about:blank) | ✔️ |
| Vimeo | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Vimeo_1.html) | ❌ `Bridge returned error 403! (20017)`<br>❌ `Type: HttpException`<br>❌ `Message: https://vimeo.com/search/sort:latest?q=birds resulted in 403 Forbidden <!doctype html>` |
| Vixen | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Vixen_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: ErrorException`<br>❌ `Message: Undefined array key "triple"` |
| Vk | [1 *untitled*](about:blank) | ✔️ |
| Vk2 | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Vk2_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: Exception`<br>❌ `Message: Missing configuration option: access_token` |
| VproTegenlicht | [1 *untitled*](about:blank) | ✔️ |
| WYMTNews | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/WYMTNews_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: ErrorException`<br>❌ `Message: Attempt to read property "href" on null` |
...
| YouTubeCommunityTab | [1 By channel ID](https://User123698745.github.io/rss-bridge-artifacts/status/YouTubeCommunityTab_1.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: ErrorException`<br>❌ `Message: Undefined property: stdClass::$c4TabbedHeaderRenderer` |
| YouTubeCommunityTab | [2 By username](https://User123698745.github.io/rss-bridge-artifacts/status/YouTubeCommunityTab_2.html) | ❌ `Bridge returned error 0! (20017)`<br>❌ `Type: ErrorException`<br>❌ `Message: Undefined property: stdClass::$c4TabbedHeaderRenderer` |
...
*last change: Monday 2024-10-21 21:35:36*