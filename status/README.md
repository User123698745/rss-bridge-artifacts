...
| ABola | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/ABola_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: Exception`<br>❌ `Message: Unable to find css selector on https://abola.pt/Nnh/Noticias` |
| AO3 | [1 List](about:blank) | ✔️ |
| AO3 | [2 Bookmarks](about:blank) | ✔️ |
| AO3 | [3 Work](https://User123698745.github.io/rss-bridge-artifacts/status/AO3_3.html) | ❌ `Bridge returned error 404! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://archiveofourown.org//works/18181853/navigate resulted in 404 Not Found <!DOCTYPE html>` |
...
| AllSides | [1 Headline Roundups](https://User123698745.github.io/rss-bridge-artifacts/status/AllSides_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://www.allsides.com/headline-roundups resulted in 403 Forbidden <!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible"...` |
...
| Anidex | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Anidex_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: cURL error Operation timed out after 5002 milliseconds with 0 bytes received: 28 (https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://anidex.moe/torrent/642559` |
| AnimeUltime | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/AnimeUltime_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: http://www.anime-ultime.net/history-0-1/062025Everything resulted in 403 Forbidden <html>` |
...
| ArtStation | [1 Search Query](https://User123698745.github.io/rss-bridge-artifacts/status/ArtStation_1.html) | ❌ `Bridge returned error 412! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://www.artstation.com/api/v2/search/projects.json resulted in 412 Precondition Failed Invalid CSRF Token` |
| Arte7 | [1 Category](about:blank) | ✔️ |
| Arte7 | [2 Collection](about:blank) | ✔️ |
| AsahiShimbunAJW | [1 *untitled*](about:blank) | ✔️ |
| Askfm | [1 Ask.fm username](https://User123698745.github.io/rss-bridge-artifacts/status/Askfm_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: cURL error Could not resolve host: ask.fm: 6 (https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://ask.fm/ApprovedAndReal` |
| AssociatedPressNews | [1 Standard Topics](https://User123698745.github.io/rss-bridge-artifacts/status/AssociatedPressNews_1.html) | ❌ `Bridge returned error 404! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://afs-prod.appspot.com/api/v2/feed/tag?tags=apf-topnews resulted in 404 Not Found ` |
| AssociatedPressNews | [2 Custom Topic](https://User123698745.github.io/rss-bridge-artifacts/status/AssociatedPressNews_2.html) | ❌ `Bridge returned error 404! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://afs-prod.appspot.com/api/v2/feed/tag?tags=europe resulted in 404 Not Found ` |
...
| Dailymotion | [1 By username](https://User123698745.github.io/rss-bridge-artifacts/status/Dailymotion_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: Error`<br>❌ `Message: Call to a member function getAttribute() on null` |
...
| Drive2ru | [1 Новости и тест-драйвы](https://User123698745.github.io/rss-bridge-artifacts/status/Drive2ru_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://www.drive2.ru/editorial/ resulted in 403 Forbidden <!doctype html><html><head><title>DDoS-Guard</title><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><link rel="stylesheet" href="/.well-kno...` |
...
| Fourchan | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Fourchan_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://boards.4chan.org/po/thread/597271 resulted in 403 Forbidden <!DOCTYPE html>` |
...
| PickyWallpapers | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/PickyWallpapers_1.html) | ❌ `Bridge returned error 404! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://www.pickywallpapers.com//page-1/ resulted in 404 Not Found <!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN">` |
...
| TheYetee | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/TheYetee_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: ErrorException`<br>❌ `Message: Attempt to read property "plaintext" on null` |
...
| TwitterV2 | [3 By list ID](https://User123698745.github.io/rss-bridge-artifacts/status/TwitterV2_3.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: Exception`<br>❌ `Message: Missing configuration option: twitterv2apitoken` |
| UberNewsroom | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/UberNewsroom_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: cURL error Could not resolve host: newsroomapi.uber.com: 6 (https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://newsroomapi.uber.com/wp-json/newsroom/v1/data?locale=en-US` |
| Unogs | [1 Global](https://User123698745.github.io/rss-bridge-artifacts/status/Unogs_1.html) | ❌ `Bridge returned error 500! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://unogs.com/api/search?query=new+last+7+days&limit=30 resulted in 500 Internal Server Error {"message": "Internal Server Error"}` |
| Unogs | [2 Country](https://User123698745.github.io/rss-bridge-artifacts/status/Unogs_2.html) | ❌ `Bridge returned error 500! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://unogs.com/api/search?query=new+last+7+days&countrylist=21&limit=30 resulted in 500 Internal Server Error {"message": "Internal Server Error"}` |
...
| ViadeoCompany | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/ViadeoCompany_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://www.viadeo.com/fr/companyle resulted in 403 Forbidden <!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" conten...` |
| Vice | [1 *untitled*](about:blank) | ✔️ |
| VideoCardz | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/VideoCardz_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://videocardz.com/sections/news resulted in 403 Forbidden <!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" conte...` |
| VieDeMerde | [1 *untitled*](about:blank) | ✔️ |
| Vimeo | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Vimeo_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: HttpException`<br>❌ `Message: https://vimeo.com/search/sort:latest?q=birds resulted in 403 Forbidden <!doctype html>` |
| Vixen | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Vixen_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: Error`<br>❌ `Message: Call to a member function innertext() on null` |
| Vk | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Vk_1.html) | ⚠️ `The feed has no items` |
| Vk2 | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/Vk2_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: Exception`<br>❌ `Message: Missing configuration option: access_token` |
| VproTegenlicht | [1 *untitled*](about:blank) | ✔️ |
| WKYTNews | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/WKYTNews_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: ErrorException`<br>❌ `Message: Attempt to read property "href" on null` |
| WYMTNews | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/WYMTNews_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: ErrorException`<br>❌ `Message: Attempt to read property "href" on null` |
...
| WordPress | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/WordPress_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: ErrorException`<br>❌ `Message: Array to string conversion` |
...
| YGGTorrent | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/YGGTorrent_1.html) | ❌ `Bridge returned error 403! (20258)`<br>❌ `Type: CloudFlareException`<br>❌ `Message: https://www3.yggtorrent.qa/engine/search?name=&description=&file=&uploader=&category=all&sub_category=all&do=search&order=desc&sort=publish_date resulted in 403 Forbidden <!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title...` |
...
| YouTubeCommunityTab | [1 By channel ID](https://User123698745.github.io/rss-bridge-artifacts/status/YouTubeCommunityTab_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: ErrorException`<br>❌ `Message: Undefined property: stdClass::$c4TabbedHeaderRenderer` |
| YouTubeCommunityTab | [2 By username](https://User123698745.github.io/rss-bridge-artifacts/status/YouTubeCommunityTab_2.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: ErrorException`<br>❌ `Message: Undefined property: stdClass::$c4TabbedHeaderRenderer` |
...
| ZDNet | [1 *untitled*](https://User123698745.github.io/rss-bridge-artifacts/status/ZDNet_1.html) | ❌ `Bridge returned error 0! (20258)`<br>❌ `Type: ErrorException`<br>❌ `Message: Array to string conversion` |
...
*last change: Thursday 2025-06-19 00:57:41*